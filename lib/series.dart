...
class tvSeries extends StatefulWidget {
  ...
  @override
  State<tvSeries> createState() => _SeriesState();
}

class _SeriesState extends State<tvSeries> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("SeriesLib", style: GoogleFonts.dancingScript(textStyle: const TextStyle(fontSize: 25)),),
        centerTitle: true,
      ),
      body: 
